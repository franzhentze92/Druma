        ...
        <section className="bg-gradient-to-r from-purple-600 to-pink-600 py-20 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <p className="text-xl text-purple-100 max-w-3xl mx-auto leading-relaxed">
              Estos términos rigen el uso de Gruma. 
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="mb-12">
                ...
                <p className="text-lg text-gray-600 leading-relaxed mb-4">
                  Bienvenido a Gruma. Estos Términos y Condiciones ("Términos") rigen tu uso de nuestra 
                  plataforma web y servicios relacionados (colectivamente, el "Servicio") operados por Gruma.
                </p>
              ...
              <div className="mb-12">
                ...
                <p className="text-lg text-gray-600 leading-relaxed mb-4">
                  Gruma es una plataforma integral para el cuidado de mascotas que ofrece:
                </p>
                ...
                <div className="space-y-6">
                  <div className="bg-blue-50 p-6 rounded-lg">
                    ...
                    <p className="text-blue-700 mb-3">
                      Mantienes todos los derechos sobre el contenido que subes a Gruma, incluyendo:
                    </p>
              ...
              <div className="mb-12">
                ...
                <div className="bg-red-50 border border-red-200 rounded-lg p-6">
                  ...
                  <p className="text-red-700 mb-3">
                    En la máxima medida permitida por la ley, Gruma no será responsable por:
                  </p>
              ...
              <div className="mb-12">
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  <ul className="text-gray-600 space-y-2">
                    <li><strong>Email:</strong> legal@gruma.com</li>
