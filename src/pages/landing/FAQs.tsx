...
export const FAQs: React.FC = () => {
  ...
  const faqs = [
    {
      question: '¿Qué es Gruma y cómo funciona?',
      answer: 'Gruma es una plataforma integral para el cuidado de mascotas que conecta dueños, veterinarios y proveedores de servicios. Ofrece 6 módulos principales: Ejercicio y Trazabilidad, Nutrición Inteligente, Veterinaria Digital, Adopción Responsable, Marketplace Integral y Recordatorios Inteligentes. Cada módulo incluye dashboards con analytics avanzados y seguimiento completo.',
      category: 'General',
      icon: PawPrint
    },
    {
      question: '¿Es Gruma completamente gratuito?',
      answer: 'Gruma ofrece un plan gratuito con funcionalidades básicas de todos los módulos. Los planes premium incluyen analytics avanzados, recordatorios personalizados, soporte prioritario y acceso a más de 1,000 productos en el marketplace. Puedes ver todos nuestros planes en la sección de precios.',
      category: 'Cuenta',
      icon: Coins
    },
    {
    ...
    },
    {
      ...
      answer: 'Absolutamente. Gruma utiliza encriptación de nivel bancario, cumple con GDPR y los más altos estándares de seguridad. Tu información y la de tus mascotas están protegidas con autenticación de dos factores. Solo tú y los veterinarios que autorices pueden acceder a los datos médicos.',
      category: 'Seguridad',
      icon: Shield
    },
    {
      question: '¿Puedo usar Gruma desde mi teléfono móvil?',
      answer: 'Sí, Gruma es completamente responsivo y optimizado para dispositivos móviles. Puedes acceder desde cualquier navegador web en tu smartphone o tablet. La interfaz se adapta perfectamente a pantallas pequeñas y todas las funcionalidades están disponibles en móvil.',
      category: 'Técnico',
      icon: Phone
    },
    {
    ...
    {
      question: '¿Qué tipos de trazabilidad ofrece Gruma?',
      answer: 'Gruma ofrece trazabilidad completa en 3 áreas: Física (ejercicio con métricas de calorías quemadas), Nutricional (horarios automáticos y cálculo de nutrientes), y Veterinaria (historial médico completo). Cada área incluye dashboards con analytics, gráficos de tendencias y recordatorios inteligentes.',
      category: 'Funcionalidades',
      icon: BarChart3
    },
    {
      question: '¿Puedo conectar con veterinarios a través de la plataforma?',
      answer: 'Sí, Gruma tiene más de 500 veterinarios verificados en la plataforma. Puedes ver sus perfiles, especialidades, reseñas de otros usuarios, disponibilidad y contactarlos directamente. También puedes compartir el historial médico completo de tus mascotas y programar citas online.',
    ...
    },
    {
      ...
      answer: 'Gruma ofrece dashboards completos con métricas de ejercicio (calorías quemadas, tiempo activo), nutrición (horarios cumplidos, análisis nutricional), salud (historial médico, próximas citas) y gastos (marketplace, veterinaria). Los reportes se pueden exportar y compartir con veterinarios.',
      category: 'Análisis',
      icon: TrendingUp
    },
    {
      ...
      <section className="bg-gradient-to-r from-purple-600 to-pink-600 py-20 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="text-xl text-purple-100 max-w-3xl mx-auto leading-relaxed">
            Encuentra respuestas rápidas a las preguntas más comunes sobre Gruma. 
