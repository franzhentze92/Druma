        ...
        <section className="bg-gradient-to-r from-purple-600 to-pink-600 py-20 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <p className="text-xl text-purple-100 max-w-3xl mx-auto leading-relaxed">
              En Gruma, protegemos y respetamos tu información personal. 
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="mb-12">
                ...
                <p className="text-lg text-gray-600 leading-relaxed mb-4">
                  En Gruma, valoramos tu confianza y nos comprometemos a proteger tu información personal. 
                ...
                <p className="text-lg text-gray-600 leading-relaxed">
                  Al usar Gruma, aceptas las prácticas descritas en esta política. 
              ...
              <div className="mb-12">
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  <ul className="text-gray-600 space-y-2">
                    <li><strong>Email:</strong> privacidad@gruma.com</li>
